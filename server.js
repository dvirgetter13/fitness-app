...
3. השתמש בשמות נפוצים ותקניים בלבד בעברית (למשל: "אגוזי לוז" ולא "אגוזי אלה", "שקדים", "אגוזי מלך", "שיבולת שועל").
4. הקפד על ערכים קלוריים ריאליים ופרופורציונליים. כדי להגיע ל-${calories} קלוריות, הגדל את הכמויות בצלחת ולא סתם לרשום מספר קלוריות גבוה.
5. הטיפ חייב להופיע בשורה נפרדת לגמרי בסוף, מתחת לסיכום!
...
🏋️‍♂️ ארוחת ביניים: 200 גרם יוגורט פרו, תפוח, 20 גרם אגוזי לוז - 280 קלוריות, 25 גרם חלבון
🍴 ארוחת ערב: קופסת טונה במים, 2 פרוסות לחם מלא, 1/2 אבוקדו, סלט ירקות - 450 קלוריות, 35 גרם חלבון
📊 סיכום: 1730 קלוריות, 132 גרם חלבון.
💡 טיפ זהב: הקפד על שתיית מים מרובה.
    `;
    ...
    try {
        ...
        // ניקוי כוכביות וסידור ירידת שורה לפני הטיפ
