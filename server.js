...
- מאכלים שאינו אוהב/אלרגיות: ${dislikedFoods || 'אין'}
...
בצע את כל החישוב בראש לפני הכתיבה! הגדל מראש את הגרמים והכמויות בצלחת ב-4 הארוחות כדי להגיע בול ל-${calories} קלוריות.
