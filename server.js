...
// --- 🥗 נתיב בניית תפריט תזונה מותאם אישית (דיוק קלורי ומתמטי מושלם) ---
...
- מאכלים שאינו אוהב/אלרגיות (אסור להשתמש בהם בכלל!): ${dislikedFoods || 'אין'}

כללי ערכים תזונתיים חובה (התבסס על טבלת המרה זו בלבד, אל תמציא קלוריות נמוכות!):
...
הנחיה חורצת:
חשב את סך הקלוריות של כל ארוחה במדויק לפי הטבלה למעלה! ארוחת ערב של בשר/טונה + לחם + טחינה שווה לפחות 450 קלוריות (אל תרשום עליה 170 או 197 קלוריות!).
הגדל את הכמויות בגרמים/פרוסות בכל ארוחה כך שסך הקלוריות של כל 4 הארוחות יחד יגיע בדיוק ל-${calories} קלוריות ול-${protein} גרם חלבון!

חוקי הרכבת המנות:
1. ארוחת בוקר: לחם מלא/שיבולת שועל + יוגורט/גבינות/טונה/אגוזים. אל תשים אורז בבוקר!
2. ארוחת צהריים: חזה עוף/פרגית/בקר + אורז/תפו"א/פסטה + ירקות ושמן זית. אל תשים יוגורט/שיבולת שועל בצהריים!
3. ארוחת ביניים: יוגורט חלבון / מעדן פרו / פרי + שקדים או אגוזים.
4. ארוחת ערב: טונה/גבינות/ביצים/בקר/עוף + לחם מלא/תפו"א + טחינה/אבוקדו + ירקות.
